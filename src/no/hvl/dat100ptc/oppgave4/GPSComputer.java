...
// beregn gjennomsnitshastighets mellom hver av gps punktene
    ...
    public double[] speeds() {
        ...
        double[] hastighetTab = new double[gpspoints.length - 1];
        for (int i = 0; i < gpspoints.length - 1; i++) {
            hastighetTab[i] = GPSUtils.speed(gpspoints[i], gpspoints[i + 1]);
        }
    ...
    public double maxSpeed() {
        ...
        double[] snittspeed = speeds();

        return GPSUtils.findMax(snittspeed);
...
// TODO - START
    ...
    public void displayStatistics() {
        ...
        System.out.println("Total distance  : " + GPSUtils.formatDouble(totalDistance()) + " m");
        ...
        System.out.println("Total energy    : " + GPSUtils.formatDouble(totalKcal(WEIGHT)) + " kcal");
